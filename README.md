# Utah Tech Week + Silicon Slopes Summit 2026 Planner
...
**Your schedule is stored in your browser's localStorage.** This means:
- Your selections persist between sessions on the same browser
- Clearing browser data will erase your schedule
- Use the **Export** button to save a copy of your schedule
...
- [Register for events on River](https://app.getriver.io/utahtechweek)
- [Summit tickets and sessions](https://community.summit.ing/events/summit-2026/sessions)
